...
interface EditAppointmentModalLawyerProps {
  appointment: IAppointment;
}

const EditAppointmentModalLawyer: React.FC<EditAppointmentModalLawyerProps> = ({
  appointment,
}) => {
...
export default EditAppointmentModalLawyer;
